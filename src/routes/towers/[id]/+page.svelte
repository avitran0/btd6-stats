<script lang="ts">
    ...
    // top, middle, bottom paths, in that order
    let pathString = "000";
    ...
    // todo: merge dps functions?
    function getDPS(attacks: Attack[]) {
        let dps = 0;
        for (let i = 0; i < attacks.length; i++) {
            if (attacks[i].reloadSpeed > 0) {
                dps += attacks[i].damage * attacks[i].pierce * attacks[i].projectiles * (1 / attacks[i].reloadSpeed);
            } else if (attacks[i - 1].reloadSpeed > 0) {
                dps +=
                    attacks[i].damage * attacks[i].pierce * attacks[i].projectiles * (1 / attacks[i - 1].reloadSpeed);
            } else {
    ...
    function getMOABDPS(attacks: Attack[]) {
        ...
        for (let i = 0; i < attacks.length; i++) {
            if (attacks[i].reloadSpeed > 0) {
                dps +=
                    attacks[i].damageMOAB * attacks[i].pierce * attacks[i].projectiles * (1 / attacks[i].reloadSpeed);
            } else if (attacks[i - 1].reloadSpeed > 0) {
                dps +=
    ...
    function getBossDPS(attacks: Attack[]) {
        ...
        for (let i = 0; i < attacks.length; i++) {
            if (attacks[i].reloadSpeed > 0) {
                dps +=
                    attacks[i].damageBoss * attacks[i].pierce * attacks[i].projectiles * (1 / attacks[i].reloadSpeed);
            } else if (attacks[i - 1].reloadSpeed > 0) {
                dps +=
    ...
    // todo: a mess, again. remove lots of duplication
    async function calculateCosts() {
        ...
        if (paths[0] < 6) {
            ...
            costs[3] += data.upgrades!["000"].costs.impoppable * 3 + data.upgrades!["600"]!.costs.impoppable;
                ...
                <table>
                    ...
                    <tr>
                        <td title="Can pop Normal Bloons?"
                            ><img src="/images/bloons/Red.png" alt="normal" loading="lazy" />{#if bloons.normal}<img
                                    src="/images/misc/TickGreenIcon.png"
                                    alt="true"
                                    loading="lazy"
                                />{:else}<img src="/images/misc/CloseIcon.png" alt="false" loading="lazy" />{/if}</td
                        >
                        <td title=" Can see Camo Bloons?"
                            ><img src="/images/bloons/GreenCamo.png" alt="camo" loading="lazy" />{#if bloons.camo}<img
                                    src="/images/misc/TickGreenIcon.png"
                                    alt="true"
                                    loading="lazy"
                                />{:else}<img src="/images/misc/CloseIcon.png" alt="false" loading="lazy" />{/if}</td
                    ...
                    <tr>
                        <td title="Can pop Black Bloons?"
                            ><img src="/images/bloons/Black.png" alt="black" loading="lazy" />{#if bloons.black}<img
                                    src="/images/misc/TickGreenIcon.png"
                                    alt="true"
                                    loading="lazy"
                                />{:else}<img src="/images/misc/CloseIcon.png" alt="false" loading="lazy" />{/if}</td
                        ...
                        <td title="Can pop White Bloons?"
                            ><img src="/images/bloons/White.png" alt="white" loading="lazy" />{#if bloons.white}<img
                                    src="/images/misc/TickGreenIcon.png"
                                    alt="true"
                                    loading="lazy"
                                />{:else}<img src="/images/misc/CloseIcon.png" alt="false" loading="lazy" />{/if}</td
                    ...
                    <tr>
                        <td title="Can pop Purple Bloons?"
                            ><img src="/images/bloons/Purple.png" alt="purple" loading="lazy" />{#if bloons.purple}<img
                                    src="/images/misc/TickGreenIcon.png"
                                    alt="true"
                                    loading="lazy"
                                />{:else}<img src="/images/misc/CloseIcon.png" alt="false" loading="lazy" />{/if}</td
